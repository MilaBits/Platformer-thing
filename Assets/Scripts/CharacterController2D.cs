...
public class CharacterController2D : MonoBehaviour {
    ...
    [SerializeField]
    private int m_jumpCount = 2; // Number of jumps allowed after being grounded

    private int m_jumpedCount = 0; // Number of jumps used after being grounded
    ...
    public void Move(float move, bool crouch, bool jump) {
        ...
        if (m_jumpedCount < m_jumpCount && jump) {
            m_jumpedCount++;
